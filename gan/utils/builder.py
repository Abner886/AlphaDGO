...
class Builders:
    ...
    def _valid_action_types(self,builder) -> dict:
        ...
        valid_op_rolling_const = self._builder.validate_op(RollingConstOperator)
        valid_op_pair_rolling = self._builder.validate_op(PairRollingOperator)

        valid_op = (valid_op_unary or valid_op_binary or valid_op_rolling or
                valid_op_rolling_const or valid_op_pair_rolling)
        ...
        ret = {
            ...
            'op': {
                ...
                RollingConstOperator: valid_op_rolling_const,
